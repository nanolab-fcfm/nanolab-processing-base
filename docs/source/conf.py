...
# nanolab_processing_base documentation build
...
from nanolab_processing_base import __version__ as release

# -- Project information -----------------------------------------------------

project = "nanolab_processing_base"
author = "Kedro"
...
htmlhelp_basename = "nanolab_processing_basedoc"
...
latex_documents = [
    (
        master_doc,
        "nanolab_processing_base.tex",
        "nanolab_processing_base Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "nanolab_processing_base",
        "Project nanolab_processing_base codebase.",
        "Data-Science",
    )
]
